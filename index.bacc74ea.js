...
})({"a8oEK":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "e1371a4bbacc74ea";
"use strict";
...
},{}],"1MYaE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utils = require("./utils");
const flagSrc = new URL(require("a599640d2cda6260"));
const mineSrc = new URL(require("f1d35bd2b15a4ee2"));
class GameView {
    gameField;
    currentMatrix;
    newGameButton;
    ...
    updateElement(element, value) {
        ...
        if (value > 0 && value < 10) element.innerText = value;
    }
    gameOver() {
    ...
    setTime(time) {
        this.gameTimer.innerText = _utils.parseTime(time);
    }
    setFlagCount(value1) {
        if (value1 < 0) return this.minesCount.innerText = '000';
        this.minesCount.innerText = _utils.fillZero`000${value1}`;
    }
    ...
    static createCellComponent(x, y) {
        ...
        const id = _utils.stringifyCoords(x, y);
    ...
    static generateGameField(matrix2, container) {
...
},{"./utils":"6PFBw","a599640d2cda6260":"8Wbcp","f1d35bd2b15a4ee2":"kmfjS","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"8Wbcp":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('jkOyE') + "flag.c0f6167b.svg" + "?" + Date.now();
...
},{}],"kmfjS":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('jkOyE') + "mine.79acbb00.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}]},["a8oEK","1MYaE"], "1MYaE", "parcelRequired5d1")

//# sourceMappingURL=index.bacc74ea.js.map
